...
\begin{itemize}
\item Arrays are our first ``collection class''.
\item Arrays are objects, so array objects are created with operator {`tt new} and array variables can have the value {\tt null}.
